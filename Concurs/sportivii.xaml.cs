...
namespace Concurs
{
    ...
    public partial class sportivii : ContentPage
    {
        ...
        public sportivii()
        {
            ...
            bool haskey = Preferences.ContainsKey("Sportivii");
            if (haskey)
            {
                string date = Preferences.Get("Sportivii", "");
                if (date != null)
                {
        ...
        private async void MyBtn_Clicked(object sender, EventArgs e)
        {
            ...
            int voturi = Convert.ToInt32(await firebase.Child("Sportivii/Voturi").OnceSingleAsync<int>());
            voturi = voturi + 1;
            await firebase.Child("Sportivii/Voturi").PutAsync(voturi);
            myBtn.IsEnabled = false;
        }
        protected override void OnDisappearing()
        {
            ...
            Preferences.Set("Sportivii", clickdate);
        }
    }
}