...
namespace Concurs
{
    ...
    public partial class Minionline : ContentPage
    {
        public DateTime dt;
        ...
        public Minionline()
        {
            ...
            bool haskey = Preferences.ContainsKey("Minionline");
            if (haskey)
            {
                string date = Preferences.Get("Minionline", "");
                if (date != null)
                {
        ...
        private async void MyBtn_Clicked(object sender, EventArgs e)
        {
            ...
            int voturi = Convert.ToInt32(await firebase.Child("Minionline/Voturi").OnceSingleAsync<int>());
            voturi = voturi + 1;
            await firebase.Child("Minionline/Voturi").PutAsync(voturi);
        ...
        protected override void OnDisappearing()
        {
            ...
            Preferences.Set("Minionline", clickdate);
        }
    }
}