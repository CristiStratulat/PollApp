...
namespace Concurs
{
    ...
    public partial class Tiger : ContentPage
    {
        ...
        public Tiger()
        {
            ...
            bool haskey = Preferences.ContainsKey("Tiger");
            if (haskey)
            {
                string date = Preferences.Get("Tiger", "");
                if (date != null)
                {
        ...
        private async void MyBtn_Clicked(object sender, EventArgs e)
        {
            ...
            int voturi = Convert.ToInt32(await firebase.Child("Tiger/Voturi").OnceSingleAsync<int>());
            voturi = voturi + 1;
            await firebase.Child("Tiger/Voturi").PutAsync(voturi);
            myBtn.IsEnabled = false;
        }
        protected override void OnDisappearing()
        {
            ...
            Preferences.Set("Tiger", clickdate);
        }
    }
}