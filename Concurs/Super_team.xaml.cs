...
namespace Concurs
{
    ...
    public partial class Super_team : ContentPage
    {
        ...
        public Super_team()
        {
            ...
            bool haskey = Preferences.ContainsKey("Super_team");
            if (haskey)
            {
                string date = Preferences.Get("Super_team", "");
                if (date != null)
                {
        ...
        private async void MyBtn_Clicked(object sender, EventArgs e)
        {
            ...
            int voturi = Convert.ToInt32(await firebase.Child("Super_team/Voturi").OnceSingleAsync<int>());
            voturi = voturi + 1;
            await firebase.Child("Super_team/Voturi").PutAsync(voturi);
            myBtn.IsEnabled = false;
        }
        protected override void OnDisappearing()
        {
            ...
            Preferences.Set("Super_team", clickdate);
        }
    }
}