...
namespace Concurs
{
    ...
    public partial class SuperGirls : ContentPage
    {
        public DateTime dt;
        ...
        public SuperGirls()
        {
            ...
            bool haskey = Preferences.ContainsKey("SuperGirls");
            if (haskey)
            {
                string date = Preferences.Get("SuperGirls", "");
                if (date != null)
                {
        ...
        private async void MyBtn_Clicked(object sender, EventArgs e)
        {
            ...
            int voturi = Convert.ToInt32(await firebase.Child("SuperGirls/Voturi").OnceSingleAsync<int>());
            voturi = voturi + 1;
            await firebase.Child("SuperGirls/Voturi").PutAsync(voturi);
            myBtn.IsEnabled = false;
        }
        protected override void OnDisappearing()
        {
            ...
            Preferences.Set("SuperGirls", clickdate);
        }
    }
}